      ...
      <div class="row">
        <div class="offset-3 col-md-6">
          <div class="tile">
            ...
            <div class="tile-body">
               <form class="form-horizontal" method="POST" action="{{ route('update_user_save',  $user->id) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('type_account') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12"> 
                                <select id="type_account" class="form-control" name="type_account" required>
                                    <option value="User" @if( $user->type_account == 'User') selected @endif>User</option>
                                    <option value="Admin" @if( $user->type_account == 'Admin') selected @endif>Admin</option>
                                    <option  value="Super Admin" @if( $user->type_account == 'Super Admin') selected @endif>Super Admin</option>
                                </select>
                 ...
                 <button class="btn btn-success btn-block" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Modifier</button>
              </form>
            </div>
