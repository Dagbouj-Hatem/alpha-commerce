  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="/abouts"><i class="app-menu__icon fa fa-info-circle" aria-hidden="true"></i><span class="app-menu__label">À propos</span></a></li>
      </ul>
    </aside>
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> À propos</h1>
          <p>A propos de nous</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i> Tableau de bord</li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">À propos .... </div>
          </div>
        </div>
      </div>
    </main>
