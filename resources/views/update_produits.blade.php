      ...
      <div class="row">
        <div class="offset-3 col-md-6">
          <div class="tile">
            ...
            <div class="tile-body">
              <form method="POST" action="{{ route('update_produit_save',  $produit->id) }}"> 
                 {{ csrf_field() }}
                ...
                <div class="form-group">
                 ...
                 <input class="form-control" type="text" placeholder="Prix ici" name="prix" value="{{ $produit->prix }}">
                </div>
                <div class="form-group">
                  <label class="control-label">Fournisseur</label> 
                  <input class="form-control" type="text" placeholder="Fournisseur ici" name="fournisseur" value="{{ $produit->fournisseur }}">
                </div>
                <div class="form-group">
                  <label class="control-label">Quantité en stock</label> 
                  <input class="form-control" type="text" placeholder="Fournisseur ici" name="qte" value="{{ $produit->qte }}">
                </div>
                <div class="form-group">
                  <label class="control-label">Remise</label> 
                  <input class="form-control" type="text" placeholder="Fournisseur ici" name="remise" value="{{ $produit->remise }}">
                </div> 
