  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview  is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Ventes</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item active" href="/ventes/add/"><i class="icon fa fa-plus-circle"></i> Ajouter</a></li>
          ...
          <div class="tile">
            <div class="tile-body"> 
              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><input type="number" name="" class="form-control" value="1" min="1"></td> 
                   
                    <td>
                      <a href="#" class="btn btn-success"><i class="fa fa-plus-circle"></i>
                        Ajouter
                      </a>  
                    </td> 
                  </tr> 
              ...
              <div class="offset-10 col-2 mt-5">
                <button class="btn btn-secondary btn-block">Suivant <i class="fa fa-arrow-circle-right"></i></button>
              </div>
            </div>
          </div>
        </div>
