      ...
      <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label"> Utilisateurs </span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item active" href="/users/"><i class="icon fa fa-list"></i> Liste des utilisateurs</a></li>
          </ul>
        </li>
              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('update_user',  $user->id) }}" class="btn btn-info btn-sm">
                        Modifier
                      </a>  
                    </td>
                    <td>
                        <a href="{{ route('delete_user',  $user->id) }}" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal">
                        Supprimer
                      </a> 
                    </td>
                  </tr> 
