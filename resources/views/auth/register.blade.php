                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4">Nom complet</label>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4">Identifiant</label>
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-4">Confirmer votre mot de passe</label>
                        ...
                        <div class="form-group{{ $errors->has('type_account') ? ' has-error' : '' }}">
                            <label for="type_account" class="col-md-4">Type de compte</label>
